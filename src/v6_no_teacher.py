...
sub.to_csv("submissions/v6_nt.csv", index=False)
print(f"\nsubmission: submissions/v6_nt.csv ({sub.shape})")

# Save OOF and test preds for ensembling
np.save("submissions/v6_nt_oof.npy", oof)
np.save("submissions/v6_nt_test.npy", test_pred)
