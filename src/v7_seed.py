...
params = {
    ...
    "lambda_l2": 1.0, "verbose": -1, "n_jobs": -1, "seed": 7,
}
...
print(f"\n=== v7_seed7 student OOF AUC: {cv_auc:.6f} ===")
...
sub.to_csv("submissions/v7_s7.csv", index=False)
np.save("submissions/v7_s7_oof.npy", oof)
np.save("submissions/v7_s7_test.npy", test_pred)
print(f"submission: submissions/v7_s7.csv")
